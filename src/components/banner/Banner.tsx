...
export default function Banner({
  ...
  const tituloClasses = classNames({
    "bg-titulo-xxxs bg-titulo-xxs bg-titulo-xs text-white font-bold xsm:text-3xl smm:text-4xl mb-4 sm:w-6/12 md:text-left md:text-2xl md:w-6/12 lgm:w-7/12 lgm:text-[28px] lg:w-7/12 lg:text-3xl xl:w-8/12 xl:text-[42px] 2xl:text-[80px] 2xl:leading-[80px] 2xl:w-6/12":
    ...
    "titulo-asistencia-xxxs titulo-asistencia-xxs titulo-asistencia-xs text-white font-bold mb-4 sm:w-6/12 md:text-left md:text-4xl md:w-6/12 lg:w-5/12 lg:text-4xl xl:w-7/12 xl:text-6xl 2xl:mt-10 2xl:text-7xl 2xl:w-[850px] 2xl:text-7xl 2xl:w-[850px]":
      location.pathname === "/home/resultados-autodiagnostico",
  });

  const descripcionClasses = classNames({
    "descripcion-xxxs descripcion-xxs descripcion-xs text-white xsm:text-2xl smm:text-3xl mb-4 sm:w-6/12 sm:text-xl md:text-left md:text-xl md:w-6/12 lg:w-7/12 lg:text-2xl xl:w-7/12 xl:text-3xl 2xl:text-4xl 2xl:w-6/12":
      location.pathname === "/home/terminos-condiciones" ||
      location.pathname === "/home/datos-registro" ||
      location.pathname === "/home/talento-humano" ||
      location.pathname === "/home/mercados" ||
  ...
  const containerClasses = classNames({
    "absolute text-center px-[5%] container-xxs container-xs container-xxxs xsm:top-[60%] smm:top-[60%] sm:top-[15%] sm:left-0 sm:text-left sm:px-10 md:top-[30%] md:left-0 md:px-16 md:text-left lgm:top-[35%] lg:top-[32%] lg:px-32 lg:left-0 lg:text-left xl:text-left xl:top-[40%] xl:px-32 xl:text-left 2xl:px-32 2xl:top-[30%]":
      location.pathname === "/home/terminos-condiciones" ||
      location.pathname === "/home/datos-registro" ||
      location.pathname === "/home/talento-humano" ||
      location.pathname === "/home/mercados" ||
